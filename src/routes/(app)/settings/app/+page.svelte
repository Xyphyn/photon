...
<CommonList>
  ...
  <Setting icon={Language}>
    ...
    {/snippet}
    <!--@ts-ignore-->
    <Select bind:value={settings.value.language}>
  ...
  {#if $locale == 'he' || $locale == 'ar'}
    <ToggleSetting
      bind:checked={settings.value.useRtl}
  ...
  <Setting icon={ViewColumns}>
    ...
    {#snippet description()}
      <p>
        {#if settings.value.view == 'cozy'}
          {$t('settings.app.view.cozy')}
        {:else if settings.value.view == 'compact'}
  ...
  <Setting optionClass="flex-2 max-w-full flex-wrap min-w-0 " icon={ChartBar}>
    ...
    >
      <Select bind:value={settings.value.defaultSort.feed}>
        {#snippet customLabel()}
      ...
      <Sort bind:selected={settings.value.defaultSort.sort} navigate={false} />
      <Select bind:value={settings.value.defaultSort.comments}>
        {#snippet customLabel()}
          <div class="flex items-center gap-1">
  ...
  <ToggleSetting
    icon={BarsArrowDown}
    bind:checked={settings.value.infiniteScroll}
  ...
  <Setting icon={Photo}>
    ...
    <Switch
      ...
      bind:selected={settings.value.leftAlign}
    />
  </Setting>
  <ToggleSetting
    icon={ArrowsRightLeft}
    bind:checked={settings.value.posts.reverseActions}
  ...
  <Setting icon={DocumentText}>
    ...
    {/snippet}
    <Select bind:value={settings.value.font}>
  ...
  <ToggleSetting
    ...
    bind:checked={settings.value.parseTags}
  />
</CommonList>
