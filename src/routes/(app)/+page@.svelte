...
<Layout>
  <Navbar slot="navbar" class="max-sm:pb-0">
    <div
      class="sm:hidden flex flex-row items-center max-w-full overflow-scroll gap-16 mt-2"
    >
      <MultiSelect
        headless
  ...
  <div class="flex flex-row gap-4 w-full">
    <div class="flex flex-col gap-4 max-w-full w-full min-w-0">
      ...
      <div
        class="hidden sm:flex flex-row gap-4 max-w-full w-full justify-between flex-wrap"
      >
        <MultiSelect
          options={['Subscribed', 'Local', 'All']}
          disabled={[$profile?.jwt == undefined]}
