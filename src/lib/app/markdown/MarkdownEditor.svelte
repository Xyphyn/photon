...
<style>
  ...
  .markdown-editor {
    --primary-box-shadow: 0px -1px 0px 0px --alpha(var(--color-slate-900) / 20%)
      inset;
    ...
    @variant dark {
      --primary-box-shadow: 0px 1.5px 0px 0px inset
        --alpha(var(--color-zinc-800) / 100%);
      --ring-box-shadow: 0px 0px 0px 2px --alpha(var(--color-primary-100) / 30%);
      background: linear-gradient(
        to bottom,
        var(--color-zinc-925) 25%,
        var(--color-zinc-900)
      );
