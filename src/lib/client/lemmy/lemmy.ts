...
export class LemmyClient implements BaseClient {
  ...
  async listCommunities(
    ...
    return await this.#client.listCommunities(...params)
  }
  ...
  async getPosts(
    ...params: Parameters<BaseClient['getPosts']>
  ): ReturnType<BaseClient['getPosts']> {
    return await this.#client.getPosts(...params)
  }
  async likePost(
  ...
  async getComments(
    ...
    return await this.#client.getComments(...params)
  }
  async getComment(
